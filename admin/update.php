...
<nav id="navbar">
        <ul class="list">
            <li class="item"><a href="managebooking.php"><--Back</a></li>
         <ul class="list">
    ...
    <div class="form">
        <div class="form-text">
            <h1><span><img src="art-1.png" alt=""></span>Update Details <span><img src="art-1.png" alt=""></span></h1>
            <h2 color="Red"><b>Please Your  details......</b></h2>
        </div>
        <div class="main-form">
